...
public class DBService {
	...
	Cliente cli1 = new Cliente(null, "Maria Silva", "mrraxa01.dev@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123") );
	cli1.getTelefones().addAll(Arrays.asList("3273988122","999199199"));
	
	Cliente cli2 = new Cliente(null, "Ana Costa", "mrraxa01@gmail.com", "72927603090", TipoCliente.PESSOAFISICA, pe.encode("123") );
	cli2.addPerfil(Perfil.ADMIN);
	cli2.getTelefones().addAll(Arrays.asList("3273988911","9991977279"));
	Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "381818818", cli1, c1);
	Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
	Endereco e3 = new Endereco(null, "Avenida Floriano", "1051", null, "Centro", "281919221", cli2, c2);
